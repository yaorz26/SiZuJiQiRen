...
: ${AMENT_CURRENT_PREFIX:="/home/yaorz/unitree_go2_ws/install/go2_sport_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_sport_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_sport_test/environment/path.sh"
