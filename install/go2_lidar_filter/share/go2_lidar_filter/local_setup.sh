...
: ${AMENT_CURRENT_PREFIX:="/home/yaorz/unitree_go2_ws/install/go2_lidar_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_lidar_filter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_lidar_filter/environment/path.sh"
